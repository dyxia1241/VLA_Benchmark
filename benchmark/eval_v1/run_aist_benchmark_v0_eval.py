#!/usr/bin/env python3
"""
AIST benchmark-v0 evaluation entrypoint.

This wrapper reuses benchmark/eval_v1/run_pilot_eval.py while switching
defaults to the AIST curated benchmark inputs.
"""
...
DEFAULT_INPUT_JSONL = BENCHMARK_DIR / "aist_benchmark_v0" / "aist_benchmark_v0_curated.jsonl"
DEFAULT_OUTPUT_JSONL = BENCHMARK_DIR / "eval_results_v1" / "aist_benchmark_v0_qwen25vl32b_full.jsonl"
DEFAULT_FRAME_DIR = BENCHMARK_DIR / "aist_benchmark_v0_frames"
